...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, cp_body):
    ...
    self.is_metric = True if self.CP.carFingerprint == CAR.HONDA_ODYSSEY_CHN else not cp.vl["CAR_SPEED"]["IMPERIAL_UNIT"]
